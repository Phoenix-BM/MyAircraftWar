...
public class ImageManager {
    ...
    public static BufferedImage BACKGROUND_IMAGE_EASYGAME;
    public static BufferedImage BACKGROUND_IMAGE_NORMALGAME;
    public static BufferedImage BACKGROUND_IMAGE_HARDGAME;
    ...
    static {
        try {
            ...
            BACKGROUND_IMAGE_EASYGAME = ImageIO.read(new FileInputStream("src/images/bg.jpg"));
            BACKGROUND_IMAGE_NORMALGAME = ImageIO.read(new FileInputStream("src/images/bg4.jpg"));
            BACKGROUND_IMAGE_HARDGAME = ImageIO.read(new FileInputStream("src/images/bg5.jpg"));
